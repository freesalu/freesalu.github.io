...
Cell.prototype.checkNeighbours = function () {
    var status = _.map(this.neighbours, function (e) { return (e.alive)? 1 : 0; });
    this.aliveNeighbours = _.reduce(status, function (m, n) {return m + n;}, 0);
}
...
GameOfLife.prototype.generate = function() {
    ...
    gol.applyToAll(function (x,y, z) {
        gol.board[[x,y,z]] = new Cell(x, y, z, !!_.random(0, 1));
    });
...
GameOfLife.prototype.update = function () {
    var gol = this;
    // Update each cell.
    _.map(gol.board, function (cell) { return cell.update(); });
    gol.currentStep += 1;
